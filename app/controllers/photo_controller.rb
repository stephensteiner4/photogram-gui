class PhotoController < ApplicationController
  ...
  def create
    ...
    new_photo.image = params.fetch("addimg_src")
    new_photo.caption = params.fetch("addimg_caption")
    new_photo.owner_id = params.fetch("addimg_ownerid")
  ...
  def update
    ...
    @photo_update.image = params.fetch("photo_editsource")
    @photo_update.caption = params.fetch("caption_edittext")
